...
// Send Message Timeout£¨¶à¾ÃÅÐ¶ÏÒ»´Î£©
#define GENERICAPP_SEND_MSG_TIMEOUT   5000     // Every 5 seconds
#define GENERICAPP_SENSOR_TIMEOUT     5000     // Every 5 seconds

//×Ô¶¨ÒåÊÂ¼þ±äÁ¿
#define GENERICAPP_SENSOR_EVT         0x0004


// Application Events (OSAL) - These are bit weighted definitions.
#define GENERICAPP_SEND_MSG_EVT       0x0001
#define GENERICAPP_LED_EVT        0x0002
