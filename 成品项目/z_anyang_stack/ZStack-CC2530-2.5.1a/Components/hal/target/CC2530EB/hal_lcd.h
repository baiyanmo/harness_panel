...
/*
 * Display roll screen on the LCD
 */
extern void HalLcdDisplayRoll(void);
/*
 * Add a string to buffer of the LCD
 */
extern void HalLcdBufferAdd(const char *str);
/*
 * Add a string to buffer of the LCD
 */
extern void HalLcdBufferAddFix(const char *str,uint16 value, uint8 format,uint8 offset);

extern void OLED_Show_Photo(uint8 col,uint8 page,uint8 width,uint8 high,uint8 *pdata);
extern void OLED_ShowxXx(uint8 col,uint8 page,uint8 width,uint8 high,uint8 *pdata);
extern void HalLcd_HW_WaitUs(uint16 microSecs);
/**************************************************************************************************
**************************************************************************************************/
